...
---@type {units:{i18n:table,locales:table},epicmenu:{i18n:table,locales:table},interface:{i18n:table,locales:table},missions:{i18n:table,locales:table}}
local translations = {
