...
function script.Create()
	...
	local wpn_3_exist = UnitDef.weapons[3] and UnitDef.weapons[3].weaponDef and WeaponDefs[UnitDef.weapons[3].weaponDef].name~="noweapon"
	if not wpn_3_exist then
		Hide (lmissiles)
		Hide (rmissiles)
		-- gg barrel and body is 1 piece
	end
end
